    ...
    $args = array(
        ...
        'meta_query' => array(
            array(
                ...
                'value' => '"Add To Slider"', // matches exactly "red", not just red. This prevents a match for "acquired"
                'compare' => 'LIKE'
            )
        )
    );
        ...
        <div class="hide-for-small-down">
            <ul class="example-orbit" data-orbit>
                <?php while ($the_query->have_posts()) : $the_query->the_post(); ?>
                    <li><img src="<?php echo get_field('slider_image', get_the_id()) ?>" alt="slider-image"/>

                        <div class="orbit-caption">
                            <a href="<?php echo get_the_permalink(get_the_id()) ?>">
                                <?php
                                    echo ( get_field('slider_caption', get_the_id()) ? get_field('slider_caption', get_the_id()) : get_the_title(get_the_id()) );
                                ?>
                            </a>
                        </div>
                    </li>
